...
export const MEMBER_PHOTOS: Record<string, string> = {
  ...
  'Oedi': 'https://lh3.googleusercontent.com/d/1QPCGeM2gwDGbGJy7RZUf02?gRZUf02qFMGFl45cY',
...
export const DAILY_PHOTO_CHALLENGES: Record<number, { id: string, name: string, icon: string }[]> = {
  ...
  5: [
    ...
    { id: 'd5-10', name: '今天「喝了多少水/茶」的空瓶大集合', icon: '瓶子' }
  ],
  6: [
  ...
  9: [
    ...
    { id: 'd9-6', name: '展示錢包裡「最後剩下的幾塊日幣職職」', icon: '🪙' },
...
export const ITINERARY_DATA: DayPlan[] = [
  {
    ...
    items: [
      { 
        time: '22:30', 
        title: '🚨 2/28 22:30 桃園機場第一航廈集合', 
        type: 'flight', 
        color: 'red', 
        isPinned: true, // 初始設為置頂
        descColor: 'red', // 初始設為紅色描述
        description: '這是【2/28 晚上】的集合時間喔！請務必準時，我們要開始彩虹冒險啦！' 
      },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '10:00', title: 'Toyota 御殿場 還車', type: 'car', link: 'https://maps.app.goo.gl/TnAM3fCZM2+KPJD76?g_st=ic' },
